...
In a DRAM cell, the three terminals map to specific roles:
  ![DRAM cell diagram](images/dram-cell.png)
...
{{< figure src="/images/1d-dram.jpg" width="400">}}
...
{{< figure src="/images/dram-array.png" width="">}}
...
{{< figure src="/images/dram-read-cycle.png" width="">}}
...
{{< figure src="/images/dram-bank.png" width="">}}
...
{{< figure src="/images/dramchip.png" width="200">}}
...
{{< figure src="/images/dram-rank.png" width="">}}

- **DIMM**: The physical stick of RAM. Can contain one or two ranks.

{{< figure src="/images/dimm.png" width="200">}}
...
{{< figure src="/images/burst.gif" width="">}}
